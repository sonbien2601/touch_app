...
- client cannot create/update/delete
- generated by `createInviteCode`
- consumed by `joinCouple`
...
Cloud Functions must use Firestore transactions for:
